...
const App = () => {
  const board = new Array(24).fill(0).map(() => new Array(10).fill(0));
  const piece = useRef([2, board[0].length / 2, 0, 0])
  ...
  return (
    <div>
      ...
      <div className="gameovertext">{gameOver.current ? 'game over' : ''}</div>
